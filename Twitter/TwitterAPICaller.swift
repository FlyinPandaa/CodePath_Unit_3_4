...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "SUazf71HizpfxjhwZ3LCwirVR", consumerSecret: "aL7nsXyBTZv9zE6NUWDiuiYG5jPSlEUpzhp9oDhcJgf0v1GeCF")
    var loginSuccess: (() -> ())?
